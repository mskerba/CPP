...
/*   Updated: 2022/12/28 13:36:36 by mskerba          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : Hit(100), Energy(50), attackDamage(20)
{
    std::cout << "ClapTrap default constructors is called!\n";
} 

ClapTrap::ClapTrap(std::string Name) : Name(Name), Hit(100), Energy(50), attackDamage(20)
{
