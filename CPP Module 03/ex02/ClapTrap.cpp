...
/*   Updated: 2022/12/27 12:24:32 by mskerba          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : Hit(100), Energy(100), attackDamage(30)
{
    std::cout << "ClapTrap default constructors is called!\n";
} 

ClapTrap::ClapTrap(std::string Name) : Name(Name), Hit(100), Energy(100), attackDamage(30)
{
